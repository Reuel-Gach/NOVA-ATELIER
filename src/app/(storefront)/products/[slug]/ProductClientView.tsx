// src/app/(storefront)/products/[slug]/ProductClientView.tsx
"use client";
...
export default function ProductClientView({ product, images }: ProductClientViewProps) {
  ...
  return (
    <main className="min-h-screen pt-32 pb-24 px-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
        ...
        {/* Right Side: Product Engineering Data & Cart Logic */}
